# Logging Amazon File Cache API calls with AWS CloudTrail<a name="logging-using-cloudtrail"></a>
...
## Amazon File Cache information in CloudTrail<a name="service-name-info-in-cloudtrail"></a>
...
## Understanding Amazon File Cache log file entries<a name="understanding-service-name-entries"></a>
